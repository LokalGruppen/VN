...
<div id="<?php echo $searchId; ?>" class="geek-search-wrapper <?php echo $moduleclass_sfx ?>">
	...
	<div class="remodal" id="geek-search-modal-<?php echo $module->id; ?>" role="dialog" aria-labelledby="modal-title-<?php echo $module->id; ?>" aria-describedby="modal-desc-<?php echo $module->id; ?>">
		<button data-remodal-action="close" class="remodal-close" aria-label="Close"></button>
		<div class="geek-search-wrapper <?php echo $moduleclass_sfx ?>">
		<div class="geek-search <?php echo $moduleclass_sfx ?>">
			<h2 id="modal-title-<?php echo $module->id; ?>"><?php echo $boxTitle; ?></h2>
			<div id="modal-desc-<?php echo $module->id; ?>" class="search-form">
