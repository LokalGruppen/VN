...
if ($item->aside_box) {
    $layout = new JLayoutFile('vn.tour.aside');
    ...
    <div class="<?php echo $aside ? 'col-md-9' : 'col-md-12'; ?>">
        ...
        <div class="card mb-3">
            <div class="card-header">
                <?php
                $layout = new JLayoutFile('vn.tour.tabs');
                echo $layout->render($item);
                ?>
            </div>
            ...
            <div class="card-body">
                <div class="tab-content py-3">
                    ...
                    <?php
                    $layout = new JLayoutFile('vn.tour.tab1');
                    echo $layout->render($item);
                    ?>

                    <?php
                    $layout = new JLayoutFile('vn.tour.tab2');
                    echo $layout->render($item);
                    ?>

                    <?php
                    $layout = new JLayoutFile('vn.tour.tab3');
                    echo $layout->render($item);
                    ?>
                </div>
            </div>
