...
$layout = new JLayoutFile('vn.tour.logo');
$buffer .= $layout->render($item);

$layout = new JLayoutFile('vn.tour.travelmap');
$buffer .= $layout->render($item);

if (!isset($item->skipLinks) || !$item->skipLinks) {
    $layout = new JLayoutFile('vn.tour.links');
    $buffer .= $layout->render($item);
}
...
<div class="tab-pane active" id="overview" role="tabpanel">
    ...
    <div class="row">
        ...
        <div class="<?php echo $aside ? 'col-md-8' : 'col-md-12'; ?>">
            ...
            <?php
            $layout = new JLayoutFile('vn.tour.price');
            ...
            <?php
            $layout = new JLayoutFile('vn.tour.book');
            echo $layout->render($item);
            ?>
