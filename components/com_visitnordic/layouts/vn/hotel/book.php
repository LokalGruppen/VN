...
$values = VNAttributes::getValues('hotel', $item->id, $field->id);
if ($values) {
...
<?php if ($booking_url || $readmore_url): ?>
    ...
    <?php if ($booking_url): ?>
        <a class="btn btn-success" href="<?php echo $booking_url; ?>"
           target="_blank"><?php echo JText::_('COM_VISITNORDIC_HOTEL_BOOKING_LINK'); ?></a>
    <?php endif; ?>

    <?php if ($readmore_url): ?>
        <a class="btn btn-success" href="<?php echo $readmore_url; ?>"
           target="_blank"><?php echo JText::_('COM_VISITNORDIC_HOTEL_BOOKING_READMORE'); ?></a>
    <?php endif; ?>
