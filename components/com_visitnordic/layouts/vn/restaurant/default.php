...
if ($item->aside_box) {
    $layout = new JLayoutFile('vn.restaurant.aside');
    ...
    <div class="<?php echo $aside ? 'col-md-9' : 'col-md-12'; ?>">
        ...
        <div class="card mb-3">
            <div class="card-header">
                <?php
                $layout = new JLayoutFile('vn.restaurant.tabs');
                echo $layout->render($item);
                ?>
            </div>
            ...
            <div class="card-body">
                <div class="tab-content py-3">
                    ...
                    <?php
                    $layout = new JLayoutFile('vn.restaurant.tab1');
                    echo $layout->render($item);
                    ?>

                    <?php
                    $layout = new JLayoutFile('vn.restaurant.tab2');
                    echo $layout->render($item);
                    ?>

                    <?php
                    $layout = new JLayoutFile('vn.restaurant.tab3');
                    echo $layout->render($item);
                    ?>
