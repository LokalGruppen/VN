        ...
        <div class="slick m-0">
            ...
            <?php foreach ($displayData as $slide): ?>
                <div class="carousel-item">
                    ...
                    <div style="background-image:url(<?php echo $cache; ?>);background-repeat:no-repeat;background-size:cover;background-position:center;height:100%;width:100%;top:0;left:0;position:absolute;" title="<?php echo $slide->title; ?>"></div>
                    <div class="w-100 h-100" style="background-color:rgba(0,0,0,0.25);top:0;left:0;position:absolute;"></div>
                    <?php if (@$slide->link): ?>
                    <a href="<?php echo $slide->link; ?>">
                        <?php endif; ?>
                        <div class="d-flex align-items-center flex-column justify-content-center text-center col-12 col-sm-10 mx-auto" style="position:relative;min-height:640px;color:#fff;">
